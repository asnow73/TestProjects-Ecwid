...
// ласс дл€ формировани€ стека с описани€ми ссылок дл€ скачивани€
public class ReaderLinksInfo
{
	...
	//‘ормирование стека с описанием ссылок дл€ скачивани€
	...
	//ѕрочитать из источника ссылки, установленного формата. ¬озвращаетс€ стек с описанием ссылок дл€ скачивани€
	//ѕример ссылки: http://example.com/archive.zip my_archive.zip
